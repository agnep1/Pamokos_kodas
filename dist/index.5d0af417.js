...
return 7!==Object.defineProperty({},1,{get:function(){return 7}})[1]});var j={},$={};$=!F(function(){// eslint-disable-next-line es/no-function-prototype-bind -- safe
var e=(function(){}).bind();// eslint-disable-next-line no-prototype-builtins -- safe
return"function"!=typeof e||e.hasOwnProperty("prototype")});var O=Function.prototype.call;j=$?O.bind(O):function(){return O.apply(O,arguments)};var L={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;o=M&&!L.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:L;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var x={},T={},A={},H=Function.prototype,I=H.call,q=$&&H.bind.bind(I,I),D={},N=(A=$?q:function(e){return function(){return I.apply(e,arguments)}})({}.toString),C=A("".slice);D=function(e){return C(N(e),8,-1)};var R=Object,W=A("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
T=F(function(){// throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
// eslint-disable-next-line no-prototype-builtins -- safe
return!R("z").propertyIsEnumerable(0)})?function(e){return"String"===D(e)?W(e,""):R(e)}:R;var z={},G={};// we can't use just `it == null` since of `document.all` special case
// https://tc39.es/ecma262/#sec-IsHTMLDDA-internal-slot-aec
G=function(e){return null==e};var B=TypeError;// `RequireObjectCoercible` abstract operation
// https://tc39.es/ecma262/#sec-requireobjectcoercible
z=function(e){if(G(e))throw new B("Can't call method on "+e);return e},x=function(e){return T(z(e))};var U={},J={},Y={},Q={},V={},K="object"==typeof document&&document.all,X=(V={all:K,IS_HTMLDDA:void 0===K&&void 0!==K}).all;// `IsCallable` abstract operation
...
ey=function(e,t){var r,n;if("string"===t&&Q(r=e.toString)&&!Y(n=j(r,e))||Q(r=e.valueOf)&&!Y(n=j(r,e))||"string"!==t&&Q(r=e.toString)&&!Y(n=j(r,e)))return n;throw new eb("Can't convert object to primitive value")};var e_={},ew={};ew=!1;var ek={},eE={},eS=Object.defineProperty;eE=function(e,t){try{eS(k,e,{value:t,configurable:!0,writable:!0})}catch(r){k[e]=t}return t};var eF="__core-js_shared__";ek=k[eF]||eE(eF,{}),(e_=function(e,t){return ek[e]||(ek[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.33.2",mode:ew?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.33.2/LICENSE",source:"https://github.com/zloirock/core-js"});var ej={},e$={},eO=Object;// `ToObject` abstract operation
// https://tc39.es/ecma262/#sec-toobject
e$=function(e){return eO(z(e))};var eL=A({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
ej=Object.hasOwn||function(e,t){return eL(e$(e),t)};var eM={},eP=0,ex=Math.random(),eT=A(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eT(++eP+ex,36)};var eA=k.Symbol,eH=e_("wks"),eI=en?eA.for||eA:eA&&eA.withoutSetter||eM,eq=TypeError,eD=(ej(eH,e="toPrimitive")||(eH[e]=ei&&ej(eA,e)?eA[e]:eI("Symbol."+e)),eH[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
J=function(e,t){if(!Y(e)||ee(e))return e;var r,n=ef(e,eD);if(n){if(void 0===t&&(t="default"),r=j(n,e,t),!Y(r)||ee(r))return r;throw new eq("Can't convert object to primitive value")}return void 0===t&&(t="number"),ey(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
U=function(e){var t=J(e,"string");return ee(t)?t:t+""};var eN={},eC={},eR=k.document,eW=Y(eR)&&Y(eR.createElement);eC=function(e){return eW?eR.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
eN=!S&&!F(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
var ez=Object.getOwnPropertyDescriptor;i=S?ez:function(e,t){if(e=x(e),t=U(t),eN)try{return ez(e,t)}catch(e){}if(ej(e,t))return P(!j(o,e,t),e[t])};var eG={},eB={};// V8 ~ Chrome 36-
// https://bugs.chromium.org/p/v8/issues/detail?id=3334
eB=S&&F(function(){// eslint-disable-next-line es/no-object-defineproperty -- required for testing
return 42!==Object.defineProperty(function(){},"prototype",{value:42,writable:!1}).prototype});var eU={},eJ=String,eY=TypeError;// `Assert: Type(argument) is Object`
eU=function(e){if(Y(e))return e;throw new eY(eJ(e)+" is not an object")};var eQ=TypeError,eV=Object.defineProperty,eK=Object.getOwnPropertyDescriptor,eX="enumerable",eZ="configurable",e0="writable";c=S?eB?function(e,t,r){if(eU(e),t=U(t),eU(r),"function"==typeof e&&"prototype"===t&&"value"in r&&e0 in r&&!r[e0]){var n=eK(e,t);n&&n[e0]&&(e[t]=r.value,r={configurable:eZ in r?r[eZ]:n[eZ],enumerable:eX in r?r[eX]:n[eX],writable:!1})}return eV(e,t,r)}:eV:function(e,t,r){if(eU(e),t=U(t),eU(r),eN)try{return eV(e,t,r)}catch(e){}if("get"in r||"set"in r)throw new eQ("Accessors not supported");return"value"in r&&(e[t]=r.value),e},eG=S?function(e,t,r){return c(e,t,P(1,r))}:function(e,t,r){return e[t]=r,e};var e1={},e2={},e4=Function.prototype,e3=S&&Object.getOwnPropertyDescriptor,e5=ej(e4,"name")&&(!S||S&&e3(e4,"name").configurable),e7={},e8=A(Function.toString);Q(ek.inspectSource)||(ek.inspectSource=function(e){return e8(e)}),e7=ek.inspectSource;var e9={},e6={},te=k.WeakMap;e6=Q(te)&&/native code/.test(String(te));var tt={},tr=e_("keys");tt=function(e){return tr[e]||(tr[e]=eM(e))};var tn={};tn={};var ti="Object already initialized",to=k.TypeError,ta=k.WeakMap;if(e6||ek.state){var ts=ek.state||(ek.state=new ta);/* eslint-disable no-self-assign -- prototype methods protection */ts.get=ts.get,ts.has=ts.has,ts.set=ts.set,/* eslint-enable no-self-assign -- prototype methods protection */u=function(e,t){if(ts.has(e))throw new to(ti);return t.facade=e,ts.set(e,t),t},l=function(e){return ts.get(e)||{}},d=function(e){return ts.has(e)}}else{var tc=tt("state");tn[tc]=!0,u=function(e,t){if(ej(e,tc))throw new to(ti);return t.facade=e,eG(e,tc,t),t},l=function(e){return ej(e,tc)?e[tc]:{}},d=function(e){return ej(e,tc)}}var tu=(e9={set:u,get:l,has:d,enforce:function(e){return d(e)?l(e):u(e,{})},getterFor:function(e){return function(t){var r;if(!Y(t)||(r=l(t)).type!==e)throw new to("Incompatible receiver, "+e+" required");return r}}}).enforce,tl=e9.get,tp=String,tf=Object.defineProperty,th=A("".slice),tv=A("".replace),tg=A([].join),tm=S&&!F(function(){return 8!==tf(function(){},"length",{value:8}).length}),ty=String(String).split("String"),tb=e2=function(e,t,r){"Symbol("===th(tp(t),0,7)&&(t="["+tv(tp(t),/^Symbol\(([^)]*)\)/,"$1")+"]"),r&&r.getter&&(t="get "+t),r&&r.setter&&(t="set "+t),(!ej(e,"name")||e5&&e.name!==t)&&(S?tf(e,"name",{value:t,configurable:!0}):e.name=t),tm&&r&&ej(r,"arity")&&e.length!==r.arity&&tf(e,"length",{value:r.arity});try{r&&ej(r,"constructor")&&r.constructor?S&&tf(e,"prototype",{writable:!1}):e.prototype&&(e.prototype=void 0)}catch(e){}var n=tu(e);return ej(n,"source")||(n.source=tg(ty,"string"==typeof t?t:"")),e};// add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
// eslint-disable-next-line no-extend-native -- required
Function.prototype.toString=tb(function(){return Q(this)&&tl(this).source||e7(this)},"toString"),e1=function(e,t,r,n){n||(n={});var i=n.enumerable,o=void 0!==n.name?n.name:t;if(Q(r)&&e2(r,o,n),n.global)i?e[t]=r:eE(t,r);else{try{n.unsafe?e[t]&&(i=!0):delete e[t]}catch(e){}i?e[t]=r:c(e,t,{value:r,enumerable:!1,configurable:!n.nonConfigurable,writable:!n.nonWritable})}return e};var t_={},tw={},tk={},tE={},tS={},tF={},tj=Math.ceil,t$=Math.floor;// `Math.trunc` method
// https://tc39.es/ecma262/#sec-math.trunc
// eslint-disable-next-line es/no-math-trunc -- safe
tF=Math.trunc||function(e){var t=+e;return(t>0?t$:tj)(t)},// `ToIntegerOrInfinity` abstract operation
// https://tc39.es/ecma262/#sec-tointegerorinfinity
tS=function(e){var t=+e;// eslint-disable-next-line no-self-compare -- NaN check
return t!=t||0===t?0:tF(t)};var tO=Math.max,tL=Math.min;// Helper for a popular repeating case of the spec:
// Let integer be ? ToInteger(index).
// If integer < 0, let result be max((length + integer), 0); else let result be min(integer, length).
tE=function(e,t){var r=tS(e);return r<0?tO(r+t,0):tL(r,t)};var tM={},tP={},tx=Math.min;// `ToLength` abstract operation
...
indexOf:tT(!1)}.indexOf,tH=A([].push);tk=function(e,t){var r,n=x(e),i=0,o=[];for(r in n)!ej(tn,r)&&ej(n,r)&&tH(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)ej(n,r=t[i++])&&(~tA(o,r)||tH(o,r));return o};var tI=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tk(e,tI)},f=Object.getOwnPropertySymbols;var tq=A([].concat);// all object keys, includes non-enumerable and symbols
tw=et("Reflect","ownKeys")||function(e){var t=p(eU(e));return f?tq(t,f(e)):t},t_=function(e,t,r){for(var n=tw(t),o=0;o<n.length;o++){var a=n[o];ej(e,a)||r&&ej(r,a)||c(e,a,i(t,a))}};var tD={},tN=/#|\.prototype\./,tC=function(e,t){var r=tW[tR(e)];return r===tG||r!==tz&&(Q(t)?F(t):!!t)},tR=tC.normalize=function(e){return String(e).replace(tN,".").toLowerCase()},tW=tC.data={},tz=tC.NATIVE="N",tG=tC.POLYFILL="P";tD=tC,/*
...
if(a=t[n],o=e.dontCallGetSet?(s=i(r,n))&&s.value:r[n],!tD(u?n:c+(l?".":"#")+n,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;t_(a,o)}(e.sham||o&&o.sham)&&eG(a,"sham",!0),e1(r,n,a,e)}};var tB={},tU={},tJ=Function.prototype,tY=tJ.apply,tQ=tJ.call;// eslint-disable-next-line es/no-reflect -- safe
tU="object"==typeof Reflect&&Reflect.apply||($?tQ.bind(tY):function(){return tQ.apply(tY,arguments)});var tV={},tK={},tX=(tK=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===D(e))return A(e)})(tK.bind);// optional / simple context binding
tV=function(e,t){return eh(e),void 0===t?e:$?tX(e,t):function(){return e.apply(t,arguments)}};var tZ={};tZ=et("document","documentElement");var t0={};t0=A([].slice);var t1={},t2=TypeError;t1=function(e,t){if(e<t)throw new t2("Not enough arguments");return e};var t4={};// eslint-disable-next-line redos/no-vulnerable -- safe
t4=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t3={};t3="process"===D(k.process);var t5=k.setImmediate,t7=k.clearImmediate,t8=k.process,t9=k.Dispatch,t6=k.Function,re=k.MessageChannel,rt=k.String,rr=0,rn={},ri="onreadystatechange";F(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
k.postMessage(rt(e),h.protocol+"//"+h.host)};t5&&t7||(t5=function(e){t1(arguments.length,1);var t=Q(e)?e:t6(e),r=t0(arguments,1);return rn[++rr]=function(){tU(t,void 0,r)},v(rr),rr},t7=function(e){delete rn[e]},t3?v=function(e){t8.nextTick(ra(e))}:t9&&t9.now?v=function(e){t9.now(ra(e))}:re&&!t4?(m=(g=new re).port2,g.port1.onmessage=rs,v=tV(m.postMessage,m)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&h&&"file:"!==h.protocol&&!F(rc)?(v=rc,k.addEventListener("message",rs,!1)):v=ri in eC("script")?function(e){tZ.appendChild(eC("script"))[ri]=function(){tZ.removeChild(this),ro(e)}}:function(e){setTimeout(ra(e),0)});var ru=(tB={set:t5,clear:t7}).clear;// `clearImmediate` method
// http://w3c.github.io/setImmediate/#si-clearImmediate
w({global:!0,bind:!0,enumerable:!0,forced:k.clearImmediate!==ru},{clearImmediate:ru});var rl=tB.set,rd={},rp={};/* global Bun -- Deno case */rp="function"==typeof Bun&&Bun&&"string"==typeof Bun.version;var rf=k.Function,rh=/MSIE .\./.test(ea)||rp&&((t=k.Bun.version.split(".")).length<3||"0"===t[0]&&(t[1]<3||"3"===t[1]&&"0"===t[2]));// IE9- / Bun 0.3.0- setTimeout / setInterval / setImmediate additional parameters fix
// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#timers
// https://github.com/oven-sh/bun/issues/1633
rd=function(e,t){var r=t?2:1;return rh?function(n,i/* , ...arguments */){var o=t1(arguments.length,1)>r,a=Q(n)?n:rf(n),s=o?t0(arguments,r):[],c=o?function(){tU(a,this,s)}:a;return t?e(c,i):e(c)}:e};// https://github.com/oven-sh/bun/issues/1633
...
a):a()}})}function F(e){var t={tryLoc:e[0]};1 in e&&(t.catchLoc=e[1]),2 in e&&(t.finallyLoc=e[2],t.afterLoc=e[3]),this.tryEntries.push(t)}function j(e){var t=e.completion||{};t.type="normal",delete t.arg,e.completion=t}function $(e){// The root entry object (effectively a try statement without a catch
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rg:Function("r","regeneratorRuntime = r")(rg)}const rm="https://forkify-api.herokuapp.com/api/v2/recipes/",ry="c45887ea-03ba-4616-922a-9a85e2b13e72",rb=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e;// in order to be able to handel error in model.js file
}},r_={recipe:{},search:{query:"",results:[],resultsPerPage:10,page:1},bookmarks:[]},rw=function(e){let{recipe:t}=e.data;return r_.recipe={id:t.id,title:t.title,publisher:t.publisher,source:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rk=async function(e){try{let t=await rb(`${rm}${e}?key=${ry}`);r_.recipe=rw(t),r_.bookmarks.some(t=>t.id==e)?r_.recipe.bookmarked=!0:r_.recipe.bookmarked=!1;//console.log(state.recipe);
}catch(e){throw console.log(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e;//--->contoller
}},rE=async function(e){try{r_.search.query=e;let t=await rb(`${rm}?search=${e}&key=${ry}`);//console.log(data);
r_.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),r_.search.page=1}catch(e){throw console.log(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e;//--->contoller
}},rS=function(e=r_.search.page){r_.search.page=e;let t=(e-1)*r_.search.resultsPerPage,r=e*r_.search.resultsPerPage;//0;
return r_.search.results.slice(t,r)},rF=function(e){r_.recipe.ingredients.forEach(t=>{t.quantity=t.quantity/r_.recipe.servings*e}),r_.recipe.servings=e},rj=function(){localStorage.setItem("bookmarks",JSON.stringify(r_.bookmarks))},r$=function(e){//add bookmark
r_.bookmarks.push(e),e.id===r_.recipe.id&&(r_.recipe.bookmarked=!0),rj()},rO=function(e){//delete current bookmark from bookmarks array
...
if(3!==t.length)throw Error("Wrong ingredient formatting! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rb(`${rm}?key=${ry}`,r);r_.recipe=rw(n),r$(r_.recipe);// console.log(data);
}catch(e){throw e}};var rM={};rM=new URL("icons.c14567a0.svg",import.meta.url).toString();class rP{_data;/**
   ...
   * @author Jonas
   * @todo Finich the implementation
   */render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}_clear(){this._parentElement.innerHTML=""}update(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentElement.querySelectorAll("*"));//newMarkup is just a string
//Comparing two elements
n.forEach((e,t)=>{let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""//selecting elements that have text inside
||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}renderSpinner(){let e=`
    <div class="spinner">
      <svg>
...
},y=Fraction;class rx extends rP{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one!";_message="";addHandlerRender(e){["hashchange","load"].forEach(t=>window.addEventListener(t,e))}addHandlerUpdateServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let n=+r.dataset.updateTo;n>0&&e(n)})}addHandlerAddBookmark(e){//using event delegation because, when we inintially load the page, bookmark element does not exist
this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--bookmark");r&&e()})}_generateMarkup(){return`
      ...
      <div class="recipe__details">
        ...
        <div>
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="${/*@__PURE__*/_(rM)}#icon-bookmark${!0===this._data.bookmarked?"-fill":""}"></use>
            </svg>
          </button>
        </div>
      </div>
      ...
      </li>`}}var rT=new rx;class rA{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rH=new rA,rI=new class extends rP{_parentElement="";_generateMarkup(){return this._data.map(e=>this._generateMarkupPreview(e)).join("")}//preview__link--active
_generateMarkup(){let e=window.location.hash.slice(1);return`
        ...
        </li>`}};class rq extends rP{_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again.";_message="";_generateMarkup(){return this._data.map(e=>rI.render(e,!1)).join()}}var rD=new rq;class rN extends rP{_parentElement=document.querySelector(".pagination");addHandlerClick(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--inline");if(!r)return;let n=+r.dataset.goto;//why + is here? String to Number
e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//Page 1, there are other pages
1===e&&t>1?`
        ...
        `:"")}}var rC=new rN;class rR extends rP{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it.";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rI.render(e,!1)).join()}}var rW=new rR;class rz extends rP{_parentElement=document.querySelector(".upload");_message="recipe was succsessfully uploaded. \uD83E\uDDD1‍\uD83C\uDF73";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rG=new rz;const rB=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rT.renderSpinner(),rD.update(rS()),rW.update(r_.bookmarks),//Loading recepie
await rk(e),rT.render(r_.recipe)}catch(e){rT.renderError()}},rU=async function(){try{rD.renderSpinner();//Get search query
let e=rH.getQuery();if(!e)return;//Load search results
await rE(e),rD.render(rS()),rC.render(r_.search)}catch(e){console.log(e)}},rJ=async function(e){try{rG.renderSpinner(),//Upload new recipe data
await rL(e),console.log(r_.recipe),rT.render(r_.recipe),rG.renderMessage(),rW.render(r_.bookmarks),//Change id in a url
window.history.pushState(null,"",`#${r_.recipe.id}`),// console.log(model.state.recipe.id);
//Close form window
setTimeout(function(){rG.toggleWindow()},2500)}catch(e){console.log("\uD83D\uDCA5",e),rG.renderError(e.message)}};rW.addHandlerRender(function(){rW.render(r_.bookmarks)}),rT.addHandlerRender(rB),rT.addHandlerUpdateServings(function(e){//update the recipe servings (in state)
rF(e),rT.update(r_.recipe)}),rT.addHandlerAddBookmark(function(){r_.recipe.bookmarked?rO(r_.recipe.id):r$(r_.recipe),rT.update(r_.recipe),rW.render(r_.bookmarks)}),rH.addHandlerSearch(rU),rC.addHandlerClick(function(e){rD.render(rS(e)),rC.render(r_.search)}),rG.addHandlerUpload(rJ);//# sourceMappingURL=index.5d0af417.js.map

//# sourceMappingURL=index.5d0af417.js.map
